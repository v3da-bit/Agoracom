...
export default function AvatarDropdown({ userData, isMobile = false }: any) {
            ...
            >
              <Popover.Panel className="absolute z-10 w-screen max-w-[260px] px-4 mt-3.5 -end-2 sm:end-0 sm:px-0">
                <div className="overflow-hidden rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-5 lg:py-7 px-5">
                    <div className="flex items-center">
                      {
                        isMobile ? <></> : (
                          <Avatar imgUrl={currentUser?.avatar?.includes('http') ? currentUser.avatar : DefaultAvatar} sizeClass="w-11 h-11" />
                        )
                      }
                    ...
                    {/* ------------------ 2 --------------------- */}
                    <div
                      className="flex items-center p-2 -m-3 cursor-pointer transition duration-150 ease-in-out rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
