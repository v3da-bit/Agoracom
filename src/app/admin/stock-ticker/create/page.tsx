    ...
    return (
        <div className="p-6 bg-white dark:bg-neutral-900 my-3">
            <div className='flex justify-between mt-2 mb-6'>
                <h3 className='text-2xl font-bold my-auto'>Create Stock Ticker</h3>
                <Link href={'/admin/stock-ticker'}><ButtonSecondary sizeClass='py-2.5 px-5'>Back</ButtonSecondary></Link>
            </div>
            <div className='grid grid-flow-row gap-2'>
                <div className=" w-full flex items-center justify-start">
                    <h1 className={style}>Tickers</h1>
                </div>
                <div className="flex-shrink-0 grow lg:grow-0 w-full mb-2">
                    ...
                    <h1 className={style2}>Add one stock symbol prepended by the exchange with no spaces i.e.: NYSE:BB</h1>
                </div>
            </div>
